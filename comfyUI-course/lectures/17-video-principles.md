...
!!! note "2026-08 前沿增补"
    MiniMax H3 把文字、图片、视频与音频参考放进统一上下文，并联合生成原生双声道视频，已通过 ComfyUI 开放权重原生模板接入。它不替代本讲的 VAE/DiT/条件注入框架，而是把“条件”从单一文本或首帧扩展为可用自然语言分工的多模态素材。模型文件、T2V/I2V/R2V 区别和 16GB 试跑边界见[第 22 讲](22-minimax-h3.html)。
