...
词频估计有个致命 bug：训练集中垃圾邮件从没出现过"教授"这个词 $\Rightarrow \hat\theta_{\text{spam},教授} = 0$ $\Rightarrow$ 任何含"教授"的邮件，垃圾类概率**恰好为零**——一个连乘里的一个零否决一切，无论其余 999 个词多么可疑。没见过 ≠ 不可能，MLE 对未见事件过度自信。
