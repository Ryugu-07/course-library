...
SITE_TITLE = "心智与证据"
SITE_SUBTITLE = "普通心理学 · 对标津巴多 · 附证据强度标注"
...
COURSE = [
    ...
    ("线一 · 方法与证据", [
        ("01-what-is-psych.md", "方法 I · 心理学是什么：六种视角"),
        ("02-methods.md", "方法 II · 研究方法与测量"),
        ("03-replication.md", "方法 III · 复现危机与证据分级"),
    ]),
    ("线二 · 生物基础", [
        ("04-neuron.md", "生物 I · 神经元与化学信使"),
        ("05-brain.md", "生物 II · 脑与行为"),
        ("06-consciousness.md", "生物 III · 意识、睡眠与药物"),
    ]),
    ("线三 · 认知", [
        ("07-perception.md", "认知 I · 感觉与知觉"),
        ("08-learning.md", "认知 II · 学习"),
        ("09-memory.md", "认知 III · 记忆"),
        ("10-thinking.md", "认知 IV · 思维、判断与决策"),
        ("11-language-intelligence.md", "认知 V · 语言与智力"),
    ]),
    ("线四 · 发展与个体", [
        ("12-development.md", "个体 I · 毕生发展"),
        ("13-motivation-emotion.md", "个体 II · 动机与情绪"),
        ("14-personality.md", "个体 III · 人格：理论与测量"),
    ]),
    ("线五 · 社会与临床", [
        ("15-social.md", "社会 I · 社会心理学与经典实验重审"),
        ("16-disorders.md", "临床 I · 心理障碍：分类与成因"),
        ("17-therapy.md", "临床 II · 心理治疗：什么有效"),
        ("18-stress-health.md", "临床 III · 压力、健康与幸福"),
    ]),
    ("线六 · 前沿与应用（核对于 2026-07）", [
        ("19-frontier.md", "前沿 I · 计算与神经科学前沿"),
        ("20-psych-ai.md", "前沿 II · 心理学与 AI"),
        ("21-applied.md", "应用 · 把心理学用在自己身上"),
    ]),
    ("收官", [
        ("22-closing.md", "收官 · 做一个明智的心理学消费者"),
    ]),
]
