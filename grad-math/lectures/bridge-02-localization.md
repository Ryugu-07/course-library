...
下一讲：[链复形与同调](bridge-03-complexes.html)；几何方向可回到本讲后继续[层与粘合](bridge-04-sheaves.html)。定义、通用性质与零环判据见 [Stacks Project：Localization](https://stacks.math.columbia.edu/tag/00CM)。资料核查：2026-09-13。
