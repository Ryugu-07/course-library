...
$$\begin{gathered}
\operatorname{Cone}(q)^{-2}=\mathbb Z,\quad
\operatorname{Cone}(q)^{-1}=\mathbb Z,\\
\operatorname{Cone}(q)^0=\mathbb Z/n,\\
\mathbb Z\xrightarrow{-n}\mathbb Z\xrightarrow{q}\mathbb Z/n.
\end{gathered}$$
