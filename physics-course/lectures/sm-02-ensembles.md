...
> 统计力学把宏观热力学写成微观状态的概率账本。本页先把“等概率”“熵”“系综”的适用条件钉牢，再用一个可精确计算的简并二能级模型，把配分函数、热容和宏观涨落放在同一张图上。
...
<h3 id="canonical-learning-title">1. 先预测：简并度、热容峰和集中分别由谁控制？</h3>
...
对 $N$ 个**相互独立且可按固定位置区分**的单元，$Z_N=Z_1^N$，而总激发单元数 $K$ 的精确分布是
...
<details markdown="1" class="answer-key"><summary>迁移答案：计数、求导与集中</summary>
