...
def f_eff_potential():
    # The reviewed native figure is regenerated by tools/build_schwarzschild_figure.py.
    # Preserve its complete exterior roots and equal-aspect trajectories during legacy bulk runs.
    return
