...
FIXTURE=Path(sys.argv[3])if len(sys.argv)>3 else ROOT/'course-shared/projects/svd-stability/qr-snapshot.json'
...
notes=[
 ...
 '固定运行快照的Q正交缺陷：经典GS玫红、改良GS橙、Householder蓝。',
...
out.append('<text x="35" y="2120" font-size="18">QR快照：2026-09-11，Node 24.14.0 / arm64；交互使用当前浏览器实际运算。</text></g></svg>')
