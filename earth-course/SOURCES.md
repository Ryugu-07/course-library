# Earth course source ledger

Last verified: **2026-09-01**.

This file records the course-wide primary references. Individual lectures should cite the closest chapter, dataset, or observing program and state the indicator year when a value can change. A scenario, model output, reanalysis product, and direct observation are not interchangeable evidence types.
...
- [WMO: State of the Global Climate 2025](https://wmo.int/publication-series/state-of-global-climate/state-of-global-climate-2025) — annual indicator report published in 2026; values must retain their indicator year and baseline.
- [NOAA: Carbon Cycle](https://www.noaa.gov/education/resource-collections/climate/carbon-cycle) — reservoirs, exchanges, greenhouse-gas observations, and ocean carbon.
- [NOAA Global Monitoring Laboratory](https://gml.noaa.gov/) — atmospheric composition observing programs and data access.

## Risk, adaptation, and mitigation framing

- [IPCC AR6 Working Group II](https://www.ipcc.ch/report/ar6/wg2/) — impacts, vulnerability, exposure, adaptation, and risk.
- [IPCC AR6 Working Group III](https://www.ipcc.ch/report/ar6/wg3/) — mitigation pathways, sector transitions, carbon removal, and enabling conditions; scenario results are conditional, not forecasts.
- [IPCC AR6 WGII Technical Summary](https://www.ipcc.ch/report/ar6/wg2/chapter/technical-summary/) — formal distinction among hazard, exposure, vulnerability, and risk.
- [IPCC AR6 WGII Chapter 17](https://www.ipcc.ch/report/ar6/wg2/chapter/chapter-17/) — decision-making under climate risk and adaptation limits.
- [IPCC AR6 Synthesis Report](https://www.ipcc.ch/report/sixth-assessment-report-cycle/) — integrated physical, impact, adaptation, and mitigation assessment.
