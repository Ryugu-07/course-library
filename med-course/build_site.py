...
SITE_TITLE = "疾病的机制"
SITE_SUBTITLE = "基础医学 · 从正常到失常 · 医学院体例"
...
COURSE = [
    ...
    ("线一 · 正常：结构与功能", [
        ("01-anatomy.md", "正常 I · 解剖学：身体的组织原则"),
        ("02-histology.md", "正常 II · 四大基本组织与细胞社会"),
        ("03-physiology-core.md", "正常 III · 生理学核心：稳态、体液与膜"),
        ("04-integration.md", "正常 IV · 整合生理：循环-呼吸-肾的耦合"),
    ]),
    ("线二 · 病理学总论", [
        ("05-cell-injury.md", "病理 I · 细胞损伤、适应与死亡"),
        ("06-inflammation.md", "病理 II · 炎症与修复"),
        ("07-hemodynamics.md", "病理 III · 血流动力学障碍与休克"),
        ("08-neoplasia.md", "病理 IV · 肿瘤：从突变到转移"),
    ]),
    ("线三 · 免疫与感染", [
        ("09-immunity.md", "免疫 I · 免疫系统的工作原理"),
        ("10-immunopathology.md", "免疫 II · 超敏、自身免疫与免疫缺陷"),
        ("11-microbiology.md", "感染 I · 病原体总论与致病机制"),
        ("12-antimicrobials.md", "感染 II · 抗微生物药、耐药与疫苗"),
    ]),
    ("线四 · 药理学", [
        ("13-pharmacokinetics.md", "药理 I · 药代动力学的定量骨架"),
        ("14-pharmacodynamics.md", "药理 II · 药效学：受体、量效与治疗窗"),
        ("15-drugs-cv.md", "药理 III · 各论：心血管与代谢"),
        ("16-drugs-cns.md", "药理 IV · 各论：神经精神与镇痛"),
    ]),
    ("线五 · 系统疾病机制", [
        ("17-cardiovascular.md", "系统 I · 心血管：从斑块到心衰"),
        ("18-respiratory.md", "系统 II · 呼吸：阻塞、限制与换气衰竭"),
        ("19-renal.md", "系统 III · 肾、水电解质与酸碱"),
        ("20-endocrine.md", "系统 IV · 内分泌与代谢（以糖尿病为主线）"),
        ("21-neuro.md", "系统 V · 神经：卒中、癫痫与神经退行"),
        ("22-gi-liver-heme.md", "系统 VI · 消化、肝与血液"),
    ]),
    ("线六 · 前沿（核对于 2026-07）", [
        ("23-molecular-therapy.md", "前沿 I · 分子医学：单抗、CAR-T、基因治疗"),
        ("24-precision.md", "前沿 II · 精准医学与 AI 在基础医学中的位置"),
    ]),
    ("收官", [
        ("25-closing.md", "收官 · 疾病的通用语法"),
    ]),
]
