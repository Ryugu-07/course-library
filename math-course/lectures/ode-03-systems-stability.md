...
<details markdown="1"><summary>展开核对：固定矩阵的长期衰减与单步放大</summary>
...
先修：[矩阵与特征值](algebra-05-eigen.html)、[一阶解的存在与延拓](ode-01-first-order.html)；后续：[无约束优化](opt-02-unconstrained.html)。
