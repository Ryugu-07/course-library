...
<details markdown="1"><summary>展开核对：先判断定义域，再计算</summary>
...
先修：[解析与 C–R 方程](complex-01-analytic.html)；后续：[绕数加权留数](complex-03-residues.html)。
