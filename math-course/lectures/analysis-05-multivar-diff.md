...
<details markdown="1"><summary>展开核对：路径幂次与约束正则性</summary>
...
先修回链：[一元线性化](analysis-02-differential.html)、[矩阵与线性映射](algebra-03-matrix.html)；后续：[约束优化与 KKT](opt-03-duality-kkt.html)。
